...
\item O uso do processo de modernização SMSOC e o design de arquitetura proposto,
...
\item Um serviço de autenticação OAuth2, 
integrado ao Sistema de Controle de Acesso (SCA) da UnB, para que os serviços desenvolvidos utilizem 
